...
export declare class UsersController {
    ...
    findAll(outletId?: string): Promise<import("../../schemas/user.schema").User[]>;
    ...
    updatePut(id: string, updateUserDto: UpdateUserDto): Promise<import("../../schemas/user.schema").User>;
