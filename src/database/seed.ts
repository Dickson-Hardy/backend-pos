...
async function seed() {
    ...
    try {
        ...
        const { User, UserRole, UserStatus } = await import('../schemas/user.schema')
        const { Outlet, OutletStatus } = await import('../schemas/outlet.schema')
        const { Product, ProductCategory, ProductStatus, UnitOfMeasure } = await import('../schemas/product.schema')
        const { Sale, PaymentMethod, SaleStatus } = await import('../schemas/sale.schema')
        ...
        const products = await productModel.insertMany([
            {
                ...
                sku: 'ACE-500-100',
                sellingPrice: 12990, // Le 12,990
                costPrice: 8500, // Le 8,500
            ...
            },
            {
                ...
                sku: 'AMX-250-30',
                sellingPrice: 18750, // Le 18,750
                costPrice: 12250, // Le 12,250
            ...
            },
            {
                ...
                sku: 'LIS-10-90',
                sellingPrice: 24500, // Le 24,500
                costPrice: 16800, // Le 16,800
                unitOfMeasure: UnitOfMeasure.TABLETS,
                packSize: 90,
                status: ProductStatus.ACTIVE,
                requiresPrescription: true,
            ...
            },
            {
                ...
                sku: 'MET-500XR-60',
                sellingPrice: 32250, // Le 32,250
                costPrice: 21500, // Le 21,500
                unitOfMeasure: UnitOfMeasure.TABLETS,
                packSize: 60,
                status: ProductStatus.ACTIVE,
                requiresPrescription: true,
            ...
            },
            {
                ...
                sku: 'OME-20DR-30',
                sellingPrice: 28990, // Le 28,990
                costPrice: 19750, // Le 19,750
                unitOfMeasure: UnitOfMeasure.CAPSULES,
                packSize: 30,
                status: ProductStatus.ACTIVE,
                requiresPrescription: false,
            ...
            },
            {
                ...
                sku: 'ATO-40-90',
                sellingPrice: 45750, // Le 45,750
                costPrice: 31250, // Le 31,250
                unitOfMeasure: UnitOfMeasure.TABLETS,
                packSize: 90,
                status: ProductStatus.ACTIVE,
                requiresPrescription: true,
            ...
            },
            {
                ...
                sku: 'ALB-90MCG-200',
                sellingPrice: 65500, // Le 65,500
                costPrice: 42750, // Le 42,750
